...
Educationally, algorithms are significant because they introduce students to structured reasoning and formal approaches to problem solving
  \cite{grover2017assessing}\cite{nijenhuis2023teaching}.
...
For example, a student can describe the logical process for sorting a list of numbers or determining the largest value in a dataset using plain
  language, diagrams, or pseudocode before implementing the procedure syntactically in software
  \cite{nijenhuis2023teaching}\cite{futschek2006algorithmic}.
...
Additional misconceptions frequently emerge around concepts such as sequencing, iteration, variables, scope, syntax and logical computation
  \cite{futschek2006algorithmic}\cite{grover2017assessing}.
...
These difficulties can become more pronounced when instruction advances too quickly from concrete examples to generalized computational models
