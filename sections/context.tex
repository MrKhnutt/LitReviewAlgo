...
Educationally, algorithms are significant because they introduce students to structured reasoning and formal approaches to problem
  solving~\cite{grover2017assessing,nijenhuis2023teaching}.
...
% Most of your paragraphs start with statements that are fairly vacuous. Think about how you can incorporate this statement into what follows.
...
Thus, Algorithms often feature prominently in secondary computer science educational standards~\cite{csta2017}.
...
Students who have previously struggled with mathematical reasoning may approach algorithmic tasks with reduced confidence or heightened apprehension,
  ...
  logical reasoning and procedural thinking than on complex computation~\cite{Voog2012,grover2017assessing}.
