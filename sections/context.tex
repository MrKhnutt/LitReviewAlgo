...
Algorithms are commonly defined as finite, ordered sets of instructions designed to accomplish a specific task or solve a particular problem~\cite{Voog2012,futschek2006algorithmic}.
...
The construction of an algorithm thus requires students to define goals, analyze constraints, test possible solutions, and revise their completed work when errors occur.
...
Although algorithms are foundational to computer science, many secondary students encounter difficulties when attempting to understand abstract computational
...
Gal states that secondary students initially perceive algorithms as synonymous with computer code rather than understanding them as a procedure or set of
...
Researchers found that students may also incorrectly assume that there is only one correct algorithmic approach to a problem, limiting creativity and flexibility in
...
%%% This was less directly supported as much as implied by the literature as a whole. I added chen2009 as they more directly state that this is the case, though that's a claim that's tangental to their research. Futschek and Bell state this somewhat more directly, but the focus of most of this research is somewhat tangental to this claim and this seems to largely stated as a given. A supporting resource would be what I used in the following sentence that describes how teenagers are still developing processes and familiarity with higher order/logical thinking.
Unlike many traditional classroom subjects that involve observable or concrete phenomena, algorithms frequently operate at a level of abstraction
  unfamiliar to secondary students~\cite{chen2009teaching,futschek2006algorithmic,bell2014presenting}.
...
The inherent relationship between mathematics and computer science can further complicate education on algorithms.
% Leery might be a more appropriate word here than wary. I'm curious what you think.
%%% I found it hard to state what i wanted in proper academic-ese. I find leery conversational, but I'm unhappy with wary as well honestly.
Many teenagers are leery of mathematics as a subject in general, which may transfer into programming and algorithmic problem solving because both
