...
% Drop however; there is already a qualifying phrase.
% Alternatively, start with however and move "in secondary education" later in the sentence.
...
% You just used therefore (without punctuation) two sentences ago. Consider rewording one of them.
...
% This sentence only serves to introduce the idea at hand. Consider shortening it.
...
% This is a really interesting claim. Do you have a citation? Does the citation in the following sentence cover it? If so, consider mentioning the
% authors in the text as you begin the concepts their research addresses.
...
% Rephrase this sentence to make it clearer and more concise.
